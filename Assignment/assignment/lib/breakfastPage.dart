...
class BreakfastPageState extends State<BreakfastPage> {
      ...
      return new ListView(
          ...
          children: [
            new Row(
              children: [
                new Spacer(),
                new Text("Breakfast Calories for Today: " +
                    _breakfastCalories.toString()),
                new Spacer()
              ],
            ),
            new Row(
  ...
  _updateCaloriesToday() async {
    int result = await DatabaseHelper.instance.getBreakfastCaloriesToday();
    if (result == null) {
      _breakfastCalories = 0;
    } else {
      _breakfastCalories = result;
    }
  }
            ...
            return ListTile(
                ...
                trailing: new IconButton(
                    ...
                    onPressed: () async {
                      ...
                      await DatabaseHelper.instance.addCaloriesToBreakfast(
